...
async function main(){
  ...
  for (var i = 0; i< subs.length; i++){
    ...
    if (sub_topics.includes(topicToNotify)){      
      ...
      console.log("Send notification to ", subs[i].client);
...
//      console.log(payload);
  ...
  // VivoPC Chrome to https://rizap-crm.github.io/pwa-ninja-food/    
  ...
  // VivoPC Android emulator to //rizap-crm.github.io/pwa-ninja-food/
  ...
  // MacMini Chrome to //rizap-crm.github.io/pwa-ninja-food/
